...
export default function CartPage() {
  const { cartItems, updateQuantity, removeItem, subtotal, delivery, total } = useCart();
    ...
    <div className="w-full py-6 md:py-10">
      <div className="w-full">
        ...
        <div className="grid lg:grid-cols-[1.3fr_0.7fr] gap-12 items-start justify-center">
          ...
          {/* LEFT SIDE: Your Bag */}
          <div className="bg-white rounded-[24px] p-6 md:p-10 shadow-sm w-full">
                  ...
                  {cartItems.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-shrink-0 bg-[#f3f3f3] rounded-[20px] md:rounded-[24px] w-[120px] h-[120px] md:w-44 md:h-44 flex items-center justify-center overflow-hidden">
                        <img
                          src={item.images?.[0] || "https://picsum.photos/300/300"}
                          alt={item.title}
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="sticky top-10">
