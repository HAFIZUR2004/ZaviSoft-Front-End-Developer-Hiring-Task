        ...
        <div className="grid lg:grid-cols-[1.3fr_0.7fr] gap-12 items-start">
          ...
          <div className="bg-white rounded-[24px] p-6 md:p-10 shadow-sm">
            ...
            {cartItems.length === 0 ? (
              ...
              <div className="space-y-10">
                ...
                {cartItems.map((item) => (
                  <div key={item.id} className="flex flex-row md:gap-8 gap-4 pb-10 border-b border-gray-100 last:border-0">
                    
                    {/* Product Image - Fixed for both Desktop & Mobile */}
          ...
          <div className="sticky top-10">
            <div className="bg-white md:bg-transparent  rounded-[24px] p-8 shadow-sm">
              <h2 className="text-[24px] md:text-[32px] text-[#232321] font-bold uppercase mb-8 tracking-tight">Order Summary</h2>
              ...
              <div className="space-y-4 text-[15px] font-bold text-gray-500">
                ...
                <div className="flex justify-between font-black text-2xl text-black pt-6 border-t border-gray-100 mt-2">
                  <span className="uppercase">Total</span>
                  <span>${total.toFixed(2)}</span>
                </div>
              </div>

              <button className="w-full mt-8 bg-[#1a1a1a] text-white py-4 md:py-5 rounded-xl font-bold text-xs uppercase tracking-[2px] hover:bg-[#4d69ff] transition-all flex items-center justify-center gap-2 shadow-lg">
                Checkout Now
              </button>
              
              <div className="mt-6 text-center">
                <button className="text-xs font-bold underline uppercase text-gray-400 hover:text-black tracking-widest transition-colors">
                  Use a promo code
                </button>
              </div>
            </div>
